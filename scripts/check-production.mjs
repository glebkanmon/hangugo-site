...
if (custom) for (const path of ['', 'support/', 'privacy/', 'terms/', 'gmetronome/', 'gmetronome/support/', 'gmetronome/privacy/', 'classroom-bot/', 'classroom-bot/privacy/', 'classroom-bot/terms/']) checks.push({ url: `https://hangugo.app/${path}`, target: `https://hangugo.app/${path}` });
