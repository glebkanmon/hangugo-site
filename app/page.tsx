...
export default function Home() {
  return <><Header /><main>
    <section className="hero shell"><div className="hero-copy">
      ...
      <p className="lede">Hangugo combines a focused Korean dictionary, spaced repetition, natural pronunciation, and AI practice shaped around your progress.</p>
      <div className="hero-actions"><span className="store-button"> &nbsp;Coming soon to the App Store</span><Link className="text-link" href="/support/">Get support <span>→</span></Link></div>
